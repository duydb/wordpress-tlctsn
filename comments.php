<?php if ( post_password_required() ) : ?>
	...
	<div class="enigma_comment_title"><h3><i class="fa fa-comments"></i> <?php echo comments_number(__(' Chưa có bình luận','enigma'), __('1 Comment','enigma'), '% Comments'); ?></h3></div>
...
<?php if ( comments_open() ) : ?>
	...
	<?php $fields=array(
		'author' => '<div class="enigma_form_group"><label for="exampleInputEmail1">'. __( 'Tên','enigma').'<small>*</small></label><input name="author" id="name" type="text" id="exampleInputEmail1" class="enigma_con_input_control"></div>',
	...
	add_filter('wl_comment_form_default_fields','my_fields');
		...
		'comment_notes_after'=>'',
		'title_reply'=> '<h2>'.__('Bình luận','enigma').'</h2>',		
		'role_form'=> 'form',		
		);
