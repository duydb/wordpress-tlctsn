...
$wp_customize->add_section(
	...
	$wp_customize->add_setting(
	'enigma_options[service_5_icons]',
		array(
		'default'=>esc_attr($wl_theme_options['service_5_icons']),
		'type'=>'option',
		'capability'=>'edit_theme_options',
		'sanitize_callback'=>'enigma_sanitize_text',
	...
	$wp_customize->add_setting(
	'enigma_options[service_6_icons]',
		array(
		'default'=>esc_attr($wl_theme_options['service_6_icons']),
		'type'=>'option',
		'capability'=>'edit_theme_options',
		'sanitize_callback'=>'enigma_sanitize_text',
	...
	$wp_customize->add_setting(
	'enigma_options[service_5_title]',
		array(
		'default'=>esc_attr($wl_theme_options['service_5_title']),
		'type'=>'option',
		'sanitize_callback'=>'enigma_sanitize_text',
		'capability'=>'edit_theme_options',
		)
	...
	$wp_customize->add_setting(
	'enigma_options[service_6_title]',
		array(
		'default'=>esc_attr($wl_theme_options['service_6_title']),
		'type'=>'option',
		'sanitize_callback'=>'enigma_sanitize_text',
		'capability'=>'edit_theme_options',
		)
	...
	$wp_customize->add_setting(
	'enigma_options[service_5_text]',
		array(
		'default'=>esc_attr($wl_theme_options['service_5_text']),
		'type'=>'option',
		'sanitize_callback'=>'enigma_sanitize_text',
		'capability'=>'edit_theme_options',
		)
	...
	$wp_customize->add_setting(
	'enigma_options[service_6_text]',
		array(
		'default'=>esc_attr($wl_theme_options['service_6_text']),
		'type'=>'option',
		'sanitize_callback'=>'enigma_sanitize_text',
		'capability'=>'edit_theme_options',
		)
	...
	$wp_customize->add_setting(
	'enigma_options[service_5_link]',
		array(
		'default'=>esc_attr($wl_theme_options['service_5_link']),
		'type'=>'option',
		'capability'=>'edit_theme_options',
		'sanitize_callback'=>'esc_url_raw',
		));
	$wp_customize->add_setting(
	'enigma_options[service_6_link]',
		array(
		'default'=>esc_attr($wl_theme_options['service_6_link']),
		'type'=>'option',
		'capability'=>'edit_theme_options',
		'sanitize_callback'=>'esc_url_raw',
		));
	...
	$wp_customize->add_control( 'service_five_title', array(
		'label'        => __( 'Service Five Title', 'enigma' ),
		'type'=>'text',
		'section'    => 'service_section',
		'settings'   => 'enigma_options[service_5_title]'
	) );
		$wp_customize->add_control( 'enigma_options[service_5_icons]',
        array(
			'label'        => __( 'Service Icon Five', 'enigma' ),
			'description'=>__('<a href="http://fontawesome.bootstrapcheatsheets.com">FontAwesome Icons</a>','enigma'),
            'section'  => 'service_section',
			'type'=>'text',
			'settings'   => 'enigma_options[service_5_icons]'
        )
    );
	$wp_customize->add_control( 'enigma_service_five_text', array(
		'label'        => __( 'Service Five Text', 'enigma' ),
		'type'=>'text',
		'section'    => 'service_section',
		'settings'   => 'enigma_options[service_5_text]'
	) );
	$wp_customize->add_control( 'service_5_link', array(
		'label'        => __( 'Service Five Link', 'enigma' ),
		'type'=>'url',
		'section'    => 'service_section',
		'settings'   => 'enigma_options[service_5_link]'
	) );
	//6
	$wp_customize->add_control(
    new enigma_Customize_Misc_Control(
        $wp_customize,
        'service_options6-line',
        array(
            'section'  => 'service_section',
            'type'     => 'line'
        )
	...
	$wp_customize->add_control( 'service_six_title', array(
		'label'        => __( 'Service Six Title', 'enigma' ),
		'type'=>'text',
		'section'    => 'service_section',
		'settings'   => 'enigma_options[service_6_title]'
	) );
		$wp_customize->add_control( 'enigma_options[service_6_icons]',
        array(
			'label'        => __( 'Service Icon Six', 'enigma' ),
			'description'=>__('<a href="http://fontawesome.bootstrapcheatsheets.com">FontAwesome Icons</a>','enigma'),
            'section'  => 'service_section',
			'type'=>'text',
			'settings'   => 'enigma_options[service_6_icons]'
        )
    );
	$wp_customize->add_control( 'enigma_service_six_text', array(
		'label'        => __( 'Service Six Text', 'enigma' ),
		'type'=>'text',
		'section'    => 'service_section',
		'settings'   => 'enigma_options[service_6_text]'
	) );
	$wp_customize->add_control( 'service_6_link', array(
		'label'        => __( 'Service Six Link', 'enigma' ),
		'type'=>'url',
		'section'    => 'service_section',
		'settings'   => 'enigma_options[service_6_link]'
	) );
/* Portfolio Section */
	$wp_customize->add_section(
        'portfolio_section',
